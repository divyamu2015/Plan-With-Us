        ...
        content: Column(
          ...
          children: [
            ...
            if (payment['payment_type'] == "card") ...[
              _historyRow(
                  "Card Holder", payment['card_holder_name'] ?? "-"),
              _historyRow(
...
Widget _historyRow(String title, dynamic value) {
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(fontSize: 16,color: const Color.fromARGB(255, 27, 146, 33)),
                ),
                 SizedBox(height: 10),
                 
                    Text(
                  "payment Status: ${booking['payment_status'] ?? 'Pending'}",
                  style: TextStyle(fontSize: 16, color: paymentStatus.toString().toLowerCase() == "completed"
        ? Colors.green
        : Colors.red,),
                ),
                 SizedBox(height: 10),
  ...
  child: (paymentStatus.toString().toLowerCase() == "completed")
      ? ElevatedButton(
          style: ElevatedButton.styleFrom(
            backgroundColor: const Color.fromARGB(255, 141, 178, 197),
          ),
         onPressed: () {
      ...
      : ElevatedButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => AdvanceBookingPaymentScreen(
                  userId: userId!,
            ...
            children: [
              IconButton(
                ...
                onPressed: () {
                  setState(() {
                    showNotifications =
                        !showNotifications; // Toggle message visibility
                    notificationCount = 0;
                  });
                },
              ),
          ...
          ListView(
            ...
            children: [
              if (showNotifications)
                _buildNotificationMessage() // Only message shows here
              else
                _buildDashboard(), // Dashboard cards appear when showNotifications is false
            ],
          ),
